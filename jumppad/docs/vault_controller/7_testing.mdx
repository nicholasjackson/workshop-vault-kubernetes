...
<Link href="{{controller_url}}" target="_blank" />
...
If you go back to the `operator` deployment:

<Link href="{{operator_url}}" target="_blank" />
 
And refresh your browser you will see the chat messages that were just added, however, since
