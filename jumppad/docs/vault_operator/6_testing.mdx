...
<a href="{{operator_url}}" target="_blank">{{operator_url}}</a>
...
using the Vault Operator. Next let's see how the same can be achieved using the
Vault controller pattern.