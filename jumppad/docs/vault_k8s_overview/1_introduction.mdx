...
In this workshop we will use all of the above strategies to secure our simple application. lets start by understanding what is Vault and how it integrates with Kubernetes.