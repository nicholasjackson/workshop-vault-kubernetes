...
Kubernetes Secrets integral part of a robust security lifecycle management. While it offers basic functionality, there are several reasons why organizations might seek a more robust solution like HashiCorp Vault:
...
In this workshop we will use all of the above strategies to secure our simple application. lets start by looking at the reference application Chat App and what security improvements it needs.