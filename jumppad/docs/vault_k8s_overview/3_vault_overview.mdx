...
curl -H "X-Vault-Request: true" -H "X-Vault-Namespace: admin/" -H "X-Vault-Token: $(vault print token)" https://do-not-delete-ever-v2-public-vault-cf6a1d76.5773df81.z1.hashicorp.cloud:8200/v1/EU_GDPR_data/data/orders/acct1
```
...
https://developer.hashicorp.com/validated-designs/vault-operating-guides-adoption/introduction
